...
Entity count under 150 ([Relevant Tutorial]({{site.baseurl}}getting_started/first_tank/optimization.html/#details))
...
Constraint count under 50 ([Relevant Tutorial]({{site.baseurl}}getting_started/first_tank/optimization.html/#wheels))
...
Physical entity count under 11 ([Relevant Tutorial]({{site.baseurl}}getting_started/first_tank/optimization.html/#wheels))
- We recommend you have 3 physical wheels per side, and avoid idler/drive wheels if possible.

Visually Optimize Armor ([Relevant Tutorial]({{site.baseurl}}getting_started/first_tank/optimization.html/#armor))
